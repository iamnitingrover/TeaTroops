...
const portraitImages: PortraitCarouselImage[] = [
  //{ id: 1, portraitUrl: "/images/carousel/portrait/1.webp", link: "/product/lavender-serenity" },
  //{ id: 2, portraitUrl: "/images/carousel/portrait/2.webp", link: "/product/blueflower-bliss" },
